...
@Component({
  selector: 'app-client-report-sections',
  standalone: true,
  ...
  templateUrl: './client-report-sections.component.html',
  styleUrl: './client-report-sections.component.scss'
})
export class ClientReportSectionsComponent implements OnInit{
