...
export class AuditReportComponent implements OnInit{
  ...
  goToGererSections(id: string){
      this.router.navigate(['/main/auditor/report-sections', id]);
  }
  ...
  setCategoryIcon(key: string) {
    switch (key) {
        ...
        case 'Directory Services (IAM Identity and Access Management Solutions)': return 'pi pi-lock';
        ...
        case 'Industrial Equipment': return 'pi pi-cog';
